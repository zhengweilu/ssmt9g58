        ...
        <div v-else>
          <el-form-item v-if="ruleForm.fengmian" label="封面" prop="fengmian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.fengmian.split(',')" :src="item" width="100" height="100">
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="答辩须知" prop="dabianxuzhi">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.dabianxuzhi" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.dabianxuzhi" label="答辩须知" prop="dabianxuzhi">
                    <span v-html="ruleForm.dabianxuzhi"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fengmian = true;
            continue;
	            	            ...
	            	            if(o=='dabianxuzhi'){
            this.ruleForm.dabianxuzhi = obj[o];
	    this.ro.dabianxuzhi = true;
            continue;
          }
	                    }
                                                                                                                              }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `dabiantongzhi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.dabiantongzhiCrossAddOrUpdateFlag = false;
                  this.parent.search();
