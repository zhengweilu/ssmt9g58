          ...
          <el-form-item class="input" label="课题名称" prop="ketimingcheng">
              <el-input v-model="ruleForm.ketimingcheng" 
                placeholder="课题名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="论文成绩" prop="lunwenchengji">
          <el-input v-model="ruleForm.lunwenchengji" 
              placeholder="论文成绩" clearable  :readonly="ro.lunwenchengji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="论文成绩" prop="lunwenchengji">
              <el-input v-model="ruleForm.lunwenchengji" 
                placeholder="论文成绩" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.ketimingcheng = true;
            continue;
	            	            ...
	            	            if(o=='lunwenchengji'){
            this.ruleForm.lunwenchengji = obj[o];
	    this.ro.lunwenchengji = true;
            continue;
          }
	            	            if(o=='dabianshijian'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `chengjipingding/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.chengjipingdingCrossAddOrUpdateFlag = false;
                  this.parent.search();
