          ...
          <el-form-item class="input" label="学生姓名" prop="xueshengxingming">
              <el-input v-model="ruleForm.xueshengxingming" 
                placeholder="学生姓名" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="论文文档" prop="lunwenwendang">
          <file-upload
          tip="点击上传论文文档"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.lunwenwendang?ruleForm.lunwenwendang:''"
          @change="lunwenwendangUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.lunwenwendang" label="论文文档" prop="lunwenwendang">
            <el-button type="text" size="small" @click="download(ruleForm.lunwenwendang)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="上交时间" prop="shangjiaoshijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.shangjiaoshijian" 
                type="date"
                placeholder="上交时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shangjiaoshijian" label="上交时间" prop="shangjiaoshijian">
              <el-input v-model="ruleForm.shangjiaoshijian" 
                placeholder="上交时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                                                                                      </el-row>
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.beizhu" label="备注" prop="beizhu">
                    <span>{{ruleForm.beizhu}}</span>
                                                                                                                                                                                  ...
                                                                                                                                                                                  <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="论文内容" prop="lunwenneirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.lunwenneirong" label="论文内容" prop="lunwenneirong">
                    <span v-html="ruleForm.lunwenneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xueshengxingming = true;
            continue;
	            	            ...
	            	            if(o=='lunwenwendang'){
            this.ruleForm.lunwenwendang = obj[o];
	    this.ro.lunwenwendang = true;
            continue;
          }
	            	            if(o=='shangjiaoshijian'){
            this.ruleForm.shangjiaoshijian = obj[o];
	    this.ro.shangjiaoshijian = true;
            continue;
          }
	            	            if(o=='beizhu'){
    ...
    back() {
      ...
      this.parent.contentStyleChange();
                                                                        ...
                                                                        lunwenwendangUploadChange(fileUrls) {
                this.ruleForm.lunwenwendang = fileUrls;
				this.addEditUploadStyleChange()
            },
                                                                        	addEditStyleChange() {
	  this.$nextTick(()=>{
