          ...
          <el-form-item class="input" v-if="ruleForm.fabushijian" label="发布时间" prop="fabushijian">
              <el-input v-model="ruleForm.fabushijian" 
                placeholder="发布时间" readonly></el-input>
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="课题内容" prop="ketineirong">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.ketineirong" label="课题内容" prop="ketineirong">
                    <span v-html="ruleForm.ketineirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
